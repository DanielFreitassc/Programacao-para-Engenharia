...
for i in range(1,11):                                                              # For sera executado repetidas vezes com base no valor de range.
    print("Insira a nota do aluno: ")                                              # Aqui mostramos uma mensagem para o usuário pedindo para insirir a nota do aluno
    nota1 = float(input("Insira a nota: "))                                        # Aqui pedimos para o usário digitar a nota 1.
    nota2 = float(input("Insira a nota: "))                                        # Aqui pedimos para o usário digitar a nota 2.
    nota3 = float(input("Insira a nota: "))                                        # Aqui pedimos para o usário digitar a nota 3.
    nota4 = float(input("Insira a nota: "))                                        # Aqui pedimos para o usário digitar a nota 4.
