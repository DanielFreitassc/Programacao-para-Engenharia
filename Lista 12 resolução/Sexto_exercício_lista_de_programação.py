lista_p1 = []                                                              # Aqui criamoos uma lista para a prova 1
...
for i in range(5):                                                         # Aqui dizemos quantas vezes a mensagem vai rodar com o range
    ...
    media_1 = soma / len(lista_p1)                                         # Aqui tiramos a media que é a soma da lista 1 dividido pela quantidade de itens da lista.
...
for i in range(5):                                                         # Aqui dizemos quantas vezes a mensagem vai rodar com o range
    ...
    lista_p2.append(nota)                                                  # Aqui Adicionamos as notas da segunda prova a lsita de provas 2.
...
if media_1 > media_2:                                                      # Se a media da primeira prova for maior que a media da segunda ele entra no if e mosta a mensagem.
    print(f"A turma obteve a melhor média na prova 1! Média: {media_1}")   # Aqui mostramos a média da primeira prova caso eal seja maior que a segunda.
else:                                                                      # Senão.
